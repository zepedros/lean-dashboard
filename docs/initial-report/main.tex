...
Final Report \\
Project and Seminar\\
Computer Science and Computer Engineering bachelor’s degree\\[20mm]
\textbf{September  2021}}

\newpage

\newpage
\title{\huge\textbf{ISEL- Instituto Superior de Engenharia de Lisboa}}
\title{\huge\textbf{Lean Dashboard}}
...
Nowadays is hard to keep track of all the information necessary to develop an application. As a project manager, you want to see all the information of your project as well as show it to your team, but this information can be scattered across different platforms. Information ranges from test results to the current sprints and are pieces of a much bigger picture and accessing the various platforms only to view can be tiring and complicated.

The goal of this project is to simplify a team’s life, by developing a web application that allows a project manager to control and show all the team members the necessary information for their project.
This application is a Single Page Application(SPA), it as a Web API, and an Extract, Transform and Load (ETL) procedure to extract and transform the information from the various data sources. This procedure extracts all the necessary information from the different platforms in order to be available through the web application.

\textbf{Keywords:} Information Aggregation, Project Managing, Project Information, Team Management, Single Page Application, Web API, no-SQL Database
\newpage
\maketitle
\title{\huge\textbf{Acknowledgements}}

The project developed by the group during this semester was done with great care and hard work from all of us. 
However, we could have never done it all by ourselves. With that said, we would like to dedicate this chapter to mention all the help and support from the people that helped in the making of this project.
