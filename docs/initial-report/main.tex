...
In this section, information such as what is already implemented within the application and the research and planning that was made for the project.
...
By the time of the delivery of this report, these are the features implemented:
...
\begin{itemize}
     ...
     \item Back-office Management with funcionalities to create, delete and edit user accounts
