...
module.exports = {
    ...
    getCredentialsById: async function(projectId, credentialId) {
        ...
        else return Promise.reject(error.create(error.DATABASE_ERROR,'CredentialId does not exist within the project'))
    },
    ...
    addCredential: async function(projectId,credentialName,credentialSource,credentials) {
        ...
        else return Promise.reject(error.create(error.DATABASE_ERROR,'Add Credential to Project Failed'))
    },
